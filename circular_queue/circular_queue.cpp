...
#define EXPECT_SIZE(X) if(!size(X)) { return false; }
#define EXPECT_PUSH(I,E) if(!push(I,E)) { return false; }
#define EXPECT_POP_NULL() if(!pop({})) { return false; }
#define EXPECT_POP(E) if(!pop({ E })) { return false; }
